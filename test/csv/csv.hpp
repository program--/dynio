...
struct csv {
    ...
    friend void read_csv(struct dyn_driver* self, byte_t* input, size_t input_size, void* output);
    friend void write_csv(struct dyn_driver* self, void* input, byte_t* output, size_t* output_size);
